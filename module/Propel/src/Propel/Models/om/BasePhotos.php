 ...
 */
abstract class BasePhotos extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Propel\\Models\\PhotosPeer';
    ...
    /**
     * The value for the path_min field.
     * @var        string
     */
    protected $path_min;
    ...
    /**
     * Initializes internal state of BasePhotos object.
     * @see        applyDefaults()
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PhotosPeer::ID;
        }
    ...
    public function setGalleryId($v)
    {
        ...
        if ($this->gallery_id !== $v) {
            $this->gallery_id = $v;
            $this->modifiedColumns[] = PhotosPeer::GALLERY_ID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = PhotosPeer::NAME;
        }
    ...
    public function setPath($v)
    {
        ...
        if ($this->path !== $v) {
            $this->path = $v;
            $this->modifiedColumns[] = PhotosPeer::PATH;
        }
    ...
    /**
     * Set the value of [path_min] column.
     *
     * @param  string $v new value
     * @return Photos The current object (for fluent API support)
     */
    public function setPathMin($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->path_min !== $v) {
            $this->path_min = $v;
            $this->modifiedColumns[] = PhotosPeer::PATH_MIN;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = PhotosPeer::DESCRIPTION;
        }
    ...
    public function setActive($v)
    {
        ...
        if ($this->active !== $v) {
            $this->active = $v;
            $this->modifiedColumns[] = PhotosPeer::ACTIVE;
        }
    ...
    public function setLastModified($v)
    {
        ...
        if ($this->last_modified !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PhotosPeer::LAST_MODIFIED;
            }
    ...
    public function setCreated($v)
    {
        ...
        if ($this->created !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PhotosPeer::CREATED;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->gallery_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            $this->name = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->path = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->path_min = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            ...
            return $startcol + 9; // 9 = PhotosPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Photos object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PhotosPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PhotosQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PhotosPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PhotosPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(PhotosPeer::GALLERY_ID)) {
            $modifiedColumns[':p' . $index++]  = '`gallery_id`';
        }
        if ($this->isColumnModified(PhotosPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(PhotosPeer::PATH)) {
            $modifiedColumns[':p' . $index++]  = '`path`';
        }
        if ($this->isColumnModified(PhotosPeer::PATH_MIN)) {
            $modifiedColumns[':p' . $index++]  = '`path_min`';
        }
        if ($this->isColumnModified(PhotosPeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`description`';
        }
        if ($this->isColumnModified(PhotosPeer::ACTIVE)) {
            $modifiedColumns[':p' . $index++]  = '`active`';
        }
        if ($this->isColumnModified(PhotosPeer::LAST_MODIFIED)) {
            $modifiedColumns[':p' . $index++]  = '`last_modified`';
        }
        if ($this->isColumnModified(PhotosPeer::CREATED)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`path`':
                        ...
                        break;
                    case '`path_min`':
                        $stmt->bindValue($identifier, $this->path_min, PDO::PARAM_STR);
                        break;
                    case '`description`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PhotosPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PhotosPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Photos'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Photos'][$this->getPrimaryKey()] = true;
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) $this->setPathMin($arr[$keys[4]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PhotosPeer::ID)) $criteria->add(PhotosPeer::ID, $this->id);
        if ($this->isColumnModified(PhotosPeer::GALLERY_ID)) $criteria->add(PhotosPeer::GALLERY_ID, $this->gallery_id);
        if ($this->isColumnModified(PhotosPeer::NAME)) $criteria->add(PhotosPeer::NAME, $this->name);
        if ($this->isColumnModified(PhotosPeer::PATH)) $criteria->add(PhotosPeer::PATH, $this->path);
        if ($this->isColumnModified(PhotosPeer::PATH_MIN)) $criteria->add(PhotosPeer::PATH_MIN, $this->path_min);
        if ($this->isColumnModified(PhotosPeer::DESCRIPTION)) $criteria->add(PhotosPeer::DESCRIPTION, $this->description);
        if ($this->isColumnModified(PhotosPeer::ACTIVE)) $criteria->add(PhotosPeer::ACTIVE, $this->active);
        if ($this->isColumnModified(PhotosPeer::LAST_MODIFIED)) $criteria->add(PhotosPeer::LAST_MODIFIED, $this->last_modified);
        if ($this->isColumnModified(PhotosPeer::CREATED)) $criteria->add(PhotosPeer::CREATED, $this->created);
    ...
    {
        $criteria = new Criteria(PhotosPeer::DATABASE_NAME);
        $criteria->add(PhotosPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Photos (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setPathMin($this->getPathMin());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Photos Clone of current object.
     * @throws PropelException
     */
    ...
    public function getGalleries(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aGalleries === null && ($this->gallery_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aGalleries->addPhotoss($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(PhotosPeer::DEFAULT_STRING_FORMAT);
    }
