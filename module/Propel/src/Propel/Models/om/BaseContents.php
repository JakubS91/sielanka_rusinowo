 ...
 */
abstract class BaseContents extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Propel\\Models\\ContentsPeer';
    ...
    /**
     * Initializes internal state of BaseContents object.
     * @see        applyDefaults()
     */
     ...
     * @return Contents The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = ContentsPeer::ID;
        }
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[] = ContentsPeer::CODE;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[] = ContentsPeer::TITLE;
        }
    ...
    public function setContent($v)
    {
        ...
        if ($this->content !== $v) {
            $this->content = $v;
            $this->modifiedColumns[] = ContentsPeer::CONTENT;
        }
    ...
    public function setActive($v)
    {
        ...
        if ($this->active !== $v) {
            $this->active = $v;
            $this->modifiedColumns[] = ContentsPeer::ACTIVE;
        }
    ...
    public function setLastModified($v)
    {
        ...
        if ($this->last_modified !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ContentsPeer::LAST_MODIFIED;
            }
    ...
    public function setCreated($v)
    {
        ...
        if ($this->created !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ContentsPeer::CREATED;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->last_modified = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            ...
            return $startcol + 7; // 7 = ContentsPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Contents object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ContentsPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ContentsQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ContentsPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ContentsPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(ContentsPeer::CODE)) {
            $modifiedColumns[':p' . $index++]  = '`code`';
        }
        if ($this->isColumnModified(ContentsPeer::TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`title`';
        }
        if ($this->isColumnModified(ContentsPeer::CONTENT)) {
            $modifiedColumns[':p' . $index++]  = '`content`';
        }
        if ($this->isColumnModified(ContentsPeer::ACTIVE)) {
            $modifiedColumns[':p' . $index++]  = '`active`';
        }
        if ($this->isColumnModified(ContentsPeer::LAST_MODIFIED)) {
            $modifiedColumns[':p' . $index++]  = '`last_modified`';
        }
        if ($this->isColumnModified(ContentsPeer::CREATED)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ContentsPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ContentsPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Contents'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Contents'][$this->getPrimaryKey()] = true;
        $keys = ContentsPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getCode(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[5], $arr)) $this->setLastModified($arr[$keys[5]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ContentsPeer::ID)) $criteria->add(ContentsPeer::ID, $this->id);
        if ($this->isColumnModified(ContentsPeer::CODE)) $criteria->add(ContentsPeer::CODE, $this->code);
        if ($this->isColumnModified(ContentsPeer::TITLE)) $criteria->add(ContentsPeer::TITLE, $this->title);
        if ($this->isColumnModified(ContentsPeer::CONTENT)) $criteria->add(ContentsPeer::CONTENT, $this->content);
        if ($this->isColumnModified(ContentsPeer::ACTIVE)) $criteria->add(ContentsPeer::ACTIVE, $this->active);
        if ($this->isColumnModified(ContentsPeer::LAST_MODIFIED)) $criteria->add(ContentsPeer::LAST_MODIFIED, $this->last_modified);
        if ($this->isColumnModified(ContentsPeer::CREATED)) $criteria->add(ContentsPeer::CREATED, $this->created);
    ...
    {
        $criteria = new Criteria(ContentsPeer::DATABASE_NAME);
        $criteria->add(ContentsPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Contents (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Contents Clone of current object.
     * @throws PropelException
     */
     ...
     * If this Contents is new, it will return
    ...
    public function setContentGalleriess(PropelCollection $contentGalleriess, PropelPDO $con = null)
    {
        ...
        foreach ($contentGalleriessToDelete as $contentGalleriesRemoved) {
            $contentGalleriesRemoved->setContents(null);
        }
    ...
    protected function doAddContentGalleries($contentGalleries)
    {
        ...
        $contentGalleries->setContents($this);
    }
    ...
    public function removeContentGalleries($contentGalleries)
    {
        if ($this->getContentGalleriess()->contains($contentGalleries)) {
            ...
            $contentGalleries->setContents(null);
        }
     ...
     * Otherwise if this Contents is new, it will return
     * an empty collection; or if this Contents has previously
     * been saved, it will retrieve related ContentGalleriess from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Contents.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|ContentGalleries[] List of ContentGalleries objects
     */
    public function getContentGalleriessJoinGalleries($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ContentGalleriesQuery::create(null, $criteria);
        $query->joinWith('Galleries', $join_behavior);
    ...
    public function setPageContentss(PropelCollection $pageContentss, PropelPDO $con = null)
    {
        ...
        foreach ($pageContentssToDelete as $pageContentsRemoved) {
            $pageContentsRemoved->setContents(null);
        }
     ...
     * @return PropelObjectCollection|PageContents[] List of PageContents objects
     */
    public function getPageContentssJoinPages($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = PageContentsQuery::create(null, $criteria);
        $query->joinWith('Pages', $join_behavior);
    ...
    {
        return (string) $this->exportTo(ContentsPeer::DEFAULT_STRING_FORMAT);
    }
