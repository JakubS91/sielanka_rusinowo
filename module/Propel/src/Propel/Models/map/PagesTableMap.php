...
class PagesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.map.PagesTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('Propel\\Models\\Pages');
        $this->setPackage('');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addColumn('action', 'Action', 'VARCHAR', true, 20, null);
    ...
    {
        $this->addRelation('PageContents', 'Propel\\Models\\PageContents', RelationMap::ONE_TO_MANY, array('id' => 'page_id', ), null, null, 'PageContentss');
    } // buildRelations()
