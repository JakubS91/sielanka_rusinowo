...
/**
 * Base class that represents a row from the 'contact_number' table.
 *
 *
 *
 * @package    propel.generator..om
 */
abstract class BaseContactNumber extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Propel\\Models\\ContactNumberPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ContactNumberPeer
     */
    ...
    /**
     * Initializes internal state of BaseContactNumber object.
     * @see        applyDefaults()
     */
     ...
     * @return ContactNumber The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = ContactNumberPeer::ID;
        }
    ...
    public function setContactId($v)
    {
        ...
        if ($this->contact_id !== $v) {
            $this->contact_id = $v;
            $this->modifiedColumns[] = ContactNumberPeer::CONTACT_ID;
        }
    ...
    public function setPhone($v)
    {
        ...
        if ($this->phone !== $v) {
            $this->phone = $v;
            $this->modifiedColumns[] = ContactNumberPeer::PHONE;
        }
    ...
    public function setActive($v)
    {
        ...
        if ($this->active !== $v) {
            $this->active = $v;
            $this->modifiedColumns[] = ContactNumberPeer::ACTIVE;
        }
    ...
    public function setCreated($v)
    {
        ...
        if ($this->created !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ContactNumberPeer::CREATED;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = ContactNumberPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ContactNumber object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ContactNumberPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ContactNumberQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ContactNumberPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ContactNumberPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(ContactNumberPeer::CONTACT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`contact_id`';
        }
        if ($this->isColumnModified(ContactNumberPeer::PHONE)) {
            $modifiedColumns[':p' . $index++]  = '`phone`';
        }
        if ($this->isColumnModified(ContactNumberPeer::ACTIVE)) {
            $modifiedColumns[':p' . $index++]  = '`active`';
        }
        if ($this->isColumnModified(ContactNumberPeer::CREATED)) {
            $modifiedColumns[':p' . $index++]  = '`created`';
        }

        $sql = sprintf(
            'INSERT INTO `contact_number` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ContactNumberPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ContactNumberPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ContactNumber'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ContactNumber'][$this->getPrimaryKey()] = true;
        $keys = ContactNumberPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ContactNumberPeer::ID)) $criteria->add(ContactNumberPeer::ID, $this->id);
        if ($this->isColumnModified(ContactNumberPeer::CONTACT_ID)) $criteria->add(ContactNumberPeer::CONTACT_ID, $this->contact_id);
        if ($this->isColumnModified(ContactNumberPeer::PHONE)) $criteria->add(ContactNumberPeer::PHONE, $this->phone);
        if ($this->isColumnModified(ContactNumberPeer::ACTIVE)) $criteria->add(ContactNumberPeer::ACTIVE, $this->active);
        if ($this->isColumnModified(ContactNumberPeer::CREATED)) $criteria->add(ContactNumberPeer::CREATED, $this->created);
    ...
    {
        $criteria = new Criteria(ContactNumberPeer::DATABASE_NAME);
        $criteria->add(ContactNumberPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of ContactNumber (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ContactNumber Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ContactNumberPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ContactNumberPeer();
        }
    ...
    public function getContact(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aContact === null && ($this->contact_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aContact->addContactNumbers($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(ContactNumberPeer::DEFAULT_STRING_FORMAT);
    }
