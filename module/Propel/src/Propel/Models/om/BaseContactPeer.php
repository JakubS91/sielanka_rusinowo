...
use Propel\Models\map\ContactTableMap;
...
abstract class BaseContactPeer
{
    ...
    const OM_CLASS = 'Propel\\Models\\Contact';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Propel\\Models\\map\\ContactTableMap';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Email', 'Active', 'Created', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'email', 'active', 'created', ),
        BasePeer::TYPE_COLNAME => array (ContactPeer::ID, ContactPeer::EMAIL, ContactPeer::ACTIVE, ContactPeer::CREATED, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'EMAIL', 'ACTIVE', 'CREATED', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'email', 'active', 'created', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Email' => 1, 'Active' => 2, 'Created' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'email' => 1, 'active' => 2, 'created' => 3, ),
        BasePeer::TYPE_COLNAME => array (ContactPeer::ID => 0, ContactPeer::EMAIL => 1, ContactPeer::ACTIVE => 2, ContactPeer::CREATED => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'EMAIL' => 1, 'ACTIVE' => 2, 'CREATED' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'email' => 1, 'active' => 2, 'created' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ContactPeer::ACTIVE);
            $criteria->addSelectColumn(ContactPeer::CREATED);
        } else {
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseContactPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Propel\Models\map\ContactTableMap());
      }
    }
